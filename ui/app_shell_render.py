...
def _safe_imports() -> _ShellDeps:
    ...
    # ✅ FIXED: follow-up tracker import (supports both names)
    try:
        from ui.issue_tracker_ui import render_issue_tracker_ui  # type: ignore
    except Exception:
        try:
    ...
    try:
        from ui.app_sections import mailto_fallback as mailto_link
    except Exception:
        mailto_link = None
